	...
	internal class EmailPrototypeSchemaState : AirSyncXsoSchemaState
	{
		...
		private void CreatePropertyConversionTable(IdMapping idmapping)
		{
			...
			base.AddProperty(new IProperty[]
			{
				...
				new XsoToProperty(PropertyType.ReadOnlyForNonDraft)
			});
			base.AddProperty(new IProperty[]
			{
				new AirSyncStringProperty(xmlNodeNamespace, "CC", false),
				new XsoCCProperty(PropertyType.ReadOnlyForNonDraft)
			});
			base.AddProperty(new IProperty[]
			{
				new AirSyncStringProperty(xmlNodeNamespace3, "Bcc", false),
				new XsoBccProperty(PropertyType.ReadOnlyForNonDraft)
			});
			base.AddProperty(new IProperty[]
			{
			...
			base.AddProperty(new IProperty[]
			{
				...
				new XsoEmailSubjectProperty(PropertyType.ReadOnlyForNonDraft)
			});
			base.AddProperty(new IProperty[]
			{
				new AirSyncStringProperty(xmlNodeNamespace, "ReplyTo", false),
				new XsoReplyToProperty(PropertyType.ReadOnlyForNonDraft)
			});
			base.AddProperty(new IProperty[]
			{
			...
			base.AddProperty(new IProperty[]
			{
				...
				new XsoIntegerProperty(ItemSchema.Importance, PropertyType.ReadOnlyForNonDraft)
			});
			base.AddProperty(new IProperty[]
			{
			...
			base.AddProperty(new IProperty[]
			{
				...
				new Xso16AttachmentsProperty(idmapping, PropertyType.ReadOnlyForNonDraft)
			});
			base.AddProperty(new IProperty[]
			{
				new AirSyncContent14Property(xmlNodeNamespace2, "Body", false),
				new XsoEmailBodyContent14Property(PropertyType.ReadOnlyForNonDraft)
			});
			base.AddProperty(new IProperty[]
			{
			...
			base.AddProperty(new IProperty[]
			{
				new AirSyncMeetingRequestProperty(xmlNodeNamespace, "MeetingRequest", false, 160),
				new XsoMeetingRequestProperty(160)
			});
			base.AddProperty(new IProperty[]
			{
			...
			base.AddProperty(new IProperty[]
			{
				new AirSyncBooleanProperty(xmlNodeNamespace3, "IsDraft", false),
				new XsoBooleanProperty(MessageItemSchema.IsDraft, PropertyType.ReadOnly)
			});
		}
