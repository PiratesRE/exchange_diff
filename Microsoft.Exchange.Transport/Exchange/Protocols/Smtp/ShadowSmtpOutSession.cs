...
namespace Microsoft.Exchange.Protocols.Smtp
{
	internal class ShadowSmtpOutSession : InboundProxySmtpOutSession
	{
		...
		protected override SmtpCommand CreateSmtpCommand(string cmd)
		{
			...
			if (cmd != null)
			{
				if (<PrivateImplementationDetails>{4DE65400-4833-4ECF-AD3A-6AE043FBDF84}.$$method0x60027f3-1 == null)
				{
					<PrivateImplementationDetails>{4DE65400-4833-4ECF-AD3A-6AE043FBDF84}.$$method0x60027f3-1 = new Dictionary<string, int>(12)
					{
						{
							"ConnectResponse",
							0
				...
				int num;
				if (<PrivateImplementationDetails>{4DE65400-4833-4ECF-AD3A-6AE043FBDF84}.$$method0x60027f3-1.TryGetValue(cmd, out num))
				{
					switch (num)
					{
					case 0:
