...
{
	internal sealed class InboundProxyDestinationPerfCountersInstance : PerformanceCounterInstance
	{
		internal InboundProxyDestinationPerfCountersInstance(string instanceName, InboundProxyDestinationPerfCountersInstance autoUpdateTotalInstance) : base(instanceName, "MSExchangeFrontendTransport InboundProxyDestinations")
		{
			bool flag = false;
		...
		internal InboundProxyDestinationPerfCountersInstance(string instanceName) : base(instanceName, "MSExchangeFrontendTransport InboundProxyDestinations")
		{
			bool flag = false;
			List<ExPerformanceCounter> list = new List<ExPerformanceCounter>();
			try
