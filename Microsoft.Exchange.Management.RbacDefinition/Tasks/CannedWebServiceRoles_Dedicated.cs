...
{
	internal class CannedWebServiceRoles_Dedicated
	{
		...
		{
			new RoleDefinition("ArchiveApplication", RoleType.ArchiveApplication, CannedWebServiceRoles_Dedicated.ArchiveApplication_Cmdlets),
			new RoleDefinition("ExchangeCrossServiceIntegration", RoleType.ExchangeCrossServiceIntegration, CannedWebServiceRoles_Dedicated.ExchangeCrossServiceIntegration_Cmdlets),
			new RoleDefinition("Legal Hold", RoleType.LegalHold, CannedWebServiceRoles_Dedicated.Legal_Hold_Cmdlets),
			new RoleDefinition("LegalHoldApplication", RoleType.LegalHoldApplication, CannedWebServiceRoles_Dedicated.LegalHoldApplication_Cmdlets),
			new RoleDefinition("Mailbox Search", RoleType.MailboxSearch, CannedWebServiceRoles_Dedicated.Mailbox_Search_Cmdlets),
			new RoleDefinition("MailboxSearchApplication", RoleType.MailboxSearchApplication, CannedWebServiceRoles_Dedicated.MailboxSearchApplication_Cmdlets),
			new RoleDefinition("My Custom Apps", RoleType.MyCustomApps, CannedWebServiceRoles_Dedicated.My_Custom_Apps_Cmdlets),
			new RoleDefinition("My Marketplace Apps", RoleType.MyMarketplaceApps, CannedWebServiceRoles_Dedicated.My_Marketplace_Apps_Cmdlets),
			new RoleDefinition("OfficeExtensionApplication", RoleType.OfficeExtensionApplication, CannedWebServiceRoles_Dedicated.OfficeExtensionApplication_Cmdlets),
			new RoleDefinition("TeamMailboxLifecycleApplication", RoleType.TeamMailboxLifecycleApplication, CannedWebServiceRoles_Dedicated.TeamMailboxLifecycleApplication_Cmdlets),
			new RoleDefinition("UserApplication", RoleType.UserApplication, CannedWebServiceRoles_Dedicated.UserApplication_Cmdlets)
		};
	}
}
