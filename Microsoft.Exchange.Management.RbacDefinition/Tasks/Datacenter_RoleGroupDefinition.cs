...
{
	internal class Datacenter_RoleGroupDefinition
	{
		internal static RoleGroupRoleMapping[] Definition = new RoleGroupRoleMapping[]
		{
			new RoleGroupRoleMapping("Access To Customer Data - DC Only", new RoleAssignmentDefinition[]
			{
				new RoleAssignmentDefinition(RoleType.AccessToCustomerDataDCOnly, RoleAssignmentDelegationType.Regular, new string[]
				{
					"*"
				}, "15.00.1014.000", false)
			}),
			...
			new RoleGroupRoleMapping("Datacenter Operations - DC Only", new RoleAssignmentDefinition[]
			{
				new RoleAssignmentDefinition(RoleType.DatacenterOperationsDCOnly, RoleAssignmentDelegationType.Regular, new string[]
				{
					"*"
				}, "15.00.1014.000", false)
			}),
			...
			new RoleGroupRoleMapping("Elevated Permissions", new RoleAssignmentDefinition[]
			{
				new RoleAssignmentDefinition(RoleType.ActiveDirectoryPermissions, RoleAssignmentDelegationType.Regular, new string[]
				{
					"*"
			...
			{
				new RoleAssignmentDefinition(RoleType.AccessToCustomerDataDCOnly, RoleAssignmentDelegationType.DelegatingOrgWide, new string[]
				{
					"*"
				}, "15.00.1014.000", false),
				...
				new RoleAssignmentDefinition(RoleType.DatacenterOperationsDCOnly, RoleAssignmentDelegationType.DelegatingOrgWide, new string[]
				{
					"*"
				}, "15.00.1014.000", false),
