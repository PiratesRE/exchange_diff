...
{
	internal class CannedWebServiceRoles_Tenant
	{
		...
		{
			new RoleDefinition("ArchiveApplication", RoleType.ArchiveApplication, CannedWebServiceRoles_Tenant.ArchiveApplication_Cmdlets),
			new RoleDefinition("ExchangeCrossServiceIntegration", RoleType.ExchangeCrossServiceIntegration, CannedWebServiceRoles_Tenant.ExchangeCrossServiceIntegration_Cmdlets),
			new RoleDefinition("Legal Hold", RoleType.LegalHold, CannedWebServiceRoles_Tenant.Legal_Hold_Cmdlets),
			new RoleDefinition("LegalHoldApplication", RoleType.LegalHoldApplication, CannedWebServiceRoles_Tenant.LegalHoldApplication_Cmdlets),
			new RoleDefinition("Mailbox Search", RoleType.MailboxSearch, CannedWebServiceRoles_Tenant.Mailbox_Search_Cmdlets),
			new RoleDefinition("MailboxSearchApplication", RoleType.MailboxSearchApplication, CannedWebServiceRoles_Tenant.MailboxSearchApplication_Cmdlets),
			new RoleDefinition("My Custom Apps", RoleType.MyCustomApps, CannedWebServiceRoles_Tenant.My_Custom_Apps_Cmdlets),
			new RoleDefinition("My Marketplace Apps", RoleType.MyMarketplaceApps, CannedWebServiceRoles_Tenant.My_Marketplace_Apps_Cmdlets),
			new RoleDefinition("OfficeExtensionApplication", RoleType.OfficeExtensionApplication, CannedWebServiceRoles_Tenant.OfficeExtensionApplication_Cmdlets),
			new RoleDefinition("TeamMailboxLifecycleApplication", RoleType.TeamMailboxLifecycleApplication, CannedWebServiceRoles_Tenant.TeamMailboxLifecycleApplication_Cmdlets),
			new RoleDefinition("UserApplication", RoleType.UserApplication, CannedWebServiceRoles_Tenant.UserApplication_Cmdlets)
		};
	}
}
