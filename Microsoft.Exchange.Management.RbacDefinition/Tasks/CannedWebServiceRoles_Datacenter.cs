...
{
	internal class CannedWebServiceRoles_Datacenter
	{
		...
		{
			new RoleDefinition("ArchiveApplication", RoleType.ArchiveApplication, CannedWebServiceRoles_Datacenter.ArchiveApplication_Cmdlets),
			new RoleDefinition("ExchangeCrossServiceIntegration", RoleType.ExchangeCrossServiceIntegration, CannedWebServiceRoles_Datacenter.ExchangeCrossServiceIntegration_Cmdlets),
			new RoleDefinition("Legal Hold", RoleType.LegalHold, CannedWebServiceRoles_Datacenter.Legal_Hold_Cmdlets),
			new RoleDefinition("LegalHoldApplication", RoleType.LegalHoldApplication, CannedWebServiceRoles_Datacenter.LegalHoldApplication_Cmdlets),
			new RoleDefinition("Mailbox Search", RoleType.MailboxSearch, CannedWebServiceRoles_Datacenter.Mailbox_Search_Cmdlets),
			new RoleDefinition("MailboxSearchApplication", RoleType.MailboxSearchApplication, CannedWebServiceRoles_Datacenter.MailboxSearchApplication_Cmdlets),
			new RoleDefinition("My Custom Apps", RoleType.MyCustomApps, CannedWebServiceRoles_Datacenter.My_Custom_Apps_Cmdlets),
			new RoleDefinition("My Marketplace Apps", RoleType.MyMarketplaceApps, CannedWebServiceRoles_Datacenter.My_Marketplace_Apps_Cmdlets),
			new RoleDefinition("OfficeExtensionApplication", RoleType.OfficeExtensionApplication, CannedWebServiceRoles_Datacenter.OfficeExtensionApplication_Cmdlets),
			new RoleDefinition("TeamMailboxLifecycleApplication", RoleType.TeamMailboxLifecycleApplication, CannedWebServiceRoles_Datacenter.TeamMailboxLifecycleApplication_Cmdlets),
			new RoleDefinition("UserApplication", RoleType.UserApplication, CannedWebServiceRoles_Datacenter.UserApplication_Cmdlets)
		};
	}
}
