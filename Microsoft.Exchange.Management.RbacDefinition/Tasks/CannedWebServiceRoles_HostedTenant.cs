...
{
	internal class CannedWebServiceRoles_HostedTenant
	{
		...
		{
			new RoleDefinition("ArchiveApplication", RoleType.ArchiveApplication, CannedWebServiceRoles_HostedTenant.ArchiveApplication_Cmdlets),
			new RoleDefinition("ExchangeCrossServiceIntegration", RoleType.ExchangeCrossServiceIntegration, CannedWebServiceRoles_HostedTenant.ExchangeCrossServiceIntegration_Cmdlets),
			new RoleDefinition("Legal Hold", RoleType.LegalHold, CannedWebServiceRoles_HostedTenant.Legal_Hold_Cmdlets),
			new RoleDefinition("LegalHoldApplication", RoleType.LegalHoldApplication, CannedWebServiceRoles_HostedTenant.LegalHoldApplication_Cmdlets),
			new RoleDefinition("Mailbox Search", RoleType.MailboxSearch, CannedWebServiceRoles_HostedTenant.Mailbox_Search_Cmdlets),
			new RoleDefinition("MailboxSearchApplication", RoleType.MailboxSearchApplication, CannedWebServiceRoles_HostedTenant.MailboxSearchApplication_Cmdlets),
			new RoleDefinition("My Custom Apps", RoleType.MyCustomApps, CannedWebServiceRoles_HostedTenant.My_Custom_Apps_Cmdlets),
			new RoleDefinition("My Marketplace Apps", RoleType.MyMarketplaceApps, CannedWebServiceRoles_HostedTenant.My_Marketplace_Apps_Cmdlets),
			new RoleDefinition("OfficeExtensionApplication", RoleType.OfficeExtensionApplication, CannedWebServiceRoles_HostedTenant.OfficeExtensionApplication_Cmdlets),
			new RoleDefinition("TeamMailboxLifecycleApplication", RoleType.TeamMailboxLifecycleApplication, CannedWebServiceRoles_HostedTenant.TeamMailboxLifecycleApplication_Cmdlets),
			new RoleDefinition("UserApplication", RoleType.UserApplication, CannedWebServiceRoles_HostedTenant.UserApplication_Cmdlets)
		};
	}
}
