...
{
	internal class CannedRoles_Dedicated
	{
		internal static RoleDefinition[] Definition = new RoleDefinition[]
		{
			new RoleDefinition("Active Directory Permissions", RoleType.ActiveDirectoryPermissions, CannedRoles_Dedicated.Active_Directory_Permissions.Cmdlets),
			new RoleDefinition("Address Lists", RoleType.AddressLists, CannedRoles_Dedicated.Address_Lists.Cmdlets),
			new RoleDefinition("ApplicationImpersonation", RoleType.ApplicationImpersonation, CannedRoles_Dedicated.ApplicationImpersonation.Cmdlets),
			new RoleDefinition("Audit Logs", RoleType.AuditLogs, CannedRoles_Dedicated.Audit_Logs.Cmdlets),
			new RoleDefinition("Cmdlet Extension Agents", RoleType.CmdletExtensionAgents, CannedRoles_Dedicated.Cmdlet_Extension_Agents.Cmdlets),
			new RoleDefinition("Data Loss Prevention", RoleType.DataLossPrevention, CannedRoles_Dedicated.Data_Loss_Prevention.Cmdlets),
			new RoleDefinition("DataCenter Destructive Operations", RoleType.DataCenterDestructiveOperations, CannedRoles_Dedicated.DataCenter_Destructive_Operations.Cmdlets),
			new RoleDefinition("DataCenter Operations", RoleType.DataCenterOperations, CannedRoles_Dedicated.DataCenter_Operations.Cmdlets),
			new RoleDefinition("Database Availability Groups", RoleType.DatabaseAvailabilityGroups, CannedRoles_Dedicated.Database_Availability_Groups.Cmdlets),
			new RoleDefinition("Database Copies", RoleType.DatabaseCopies, CannedRoles_Dedicated.Database_Copies.Cmdlets),
			new RoleDefinition("Databases", RoleType.Databases, CannedRoles_Dedicated.Databases.Cmdlets),
			new RoleDefinition("Disaster Recovery", RoleType.DisasterRecovery, CannedRoles_Dedicated.Disaster_Recovery.Cmdlets),
			new RoleDefinition("Distribution Groups", RoleType.DistributionGroups, CannedRoles_Dedicated.Distribution_Groups.Cmdlets),
			new RoleDefinition("E-Mail Address Policies", RoleType.EmailAddressPolicies, CannedRoles_Dedicated.E_Mail_Address_Policies.Cmdlets),
			new RoleDefinition("Edge Subscriptions", RoleType.EdgeSubscriptions, CannedRoles_Dedicated.Edge_Subscriptions.Cmdlets),
			new RoleDefinition("Exchange Connectors", RoleType.ExchangeConnectors, CannedRoles_Dedicated.Exchange_Connectors.Cmdlets),
			new RoleDefinition("Exchange Server Certificates", RoleType.ExchangeServerCertificates, CannedRoles_Dedicated.Exchange_Server_Certificates.Cmdlets),
			new RoleDefinition("Exchange Servers", RoleType.ExchangeServers, CannedRoles_Dedicated.Exchange_Servers.Cmdlets),
			new RoleDefinition("Exchange Virtual Directories", RoleType.ExchangeVirtualDirectories, CannedRoles_Dedicated.Exchange_Virtual_Directories.Cmdlets),
			new RoleDefinition("ExchangeCrossServiceIntegration", RoleType.ExchangeCrossServiceIntegration, CannedRoles_Dedicated.ExchangeCrossServiceIntegration.Cmdlets),
			new RoleDefinition("Federated Sharing", RoleType.FederatedSharing, CannedRoles_Dedicated.Federated_Sharing.Cmdlets),
			new RoleDefinition("Information Rights Management", RoleType.InformationRightsManagement, CannedRoles_Dedicated.Information_Rights_Management.Cmdlets),
			new RoleDefinition("Journaling", RoleType.Journaling, CannedRoles_Dedicated.Journaling.Cmdlets),
			new RoleDefinition("Legal Hold", RoleType.LegalHold, CannedRoles_Dedicated.Legal_Hold.Cmdlets),
			new RoleDefinition("Mail Enabled Public Folders", RoleType.MailEnabledPublicFolders, CannedRoles_Dedicated.Mail_Enabled_Public_Folders.Cmdlets),
			new RoleDefinition("Mail Recipient Creation", RoleType.MailRecipientCreation, CannedRoles_Dedicated.Mail_Recipient_Creation.Cmdlets),
			new RoleDefinition("Mail Recipients", RoleType.MailRecipients, CannedRoles_Dedicated.Mail_Recipients.Cmdlets),
			new RoleDefinition("Mail Tips", RoleType.MailTips, CannedRoles_Dedicated.Mail_Tips.Cmdlets),
			new RoleDefinition("Mailbox Import Export", RoleType.MailboxImportExport, CannedRoles_Dedicated.Mailbox_Import_Export.Cmdlets),
			new RoleDefinition("Mailbox Search", RoleType.MailboxSearch, CannedRoles_Dedicated.Mailbox_Search.Cmdlets),
			new RoleDefinition("Message Tracking", RoleType.MessageTracking, CannedRoles_Dedicated.Message_Tracking.Cmdlets),
			new RoleDefinition("Migration", RoleType.Migration, CannedRoles_Dedicated.Migration.Cmdlets),
			new RoleDefinition("Monitoring", RoleType.Monitoring, CannedRoles_Dedicated.Monitoring.Cmdlets),
			new RoleDefinition("Move Mailboxes", RoleType.MoveMailboxes, CannedRoles_Dedicated.Move_Mailboxes.Cmdlets),
			new RoleDefinition("My Custom Apps", RoleType.MyCustomApps, CannedRoles_Dedicated.My_Custom_Apps.Cmdlets),
			new RoleDefinition("My Marketplace Apps", RoleType.MyMarketplaceApps, CannedRoles_Dedicated.My_Marketplace_Apps.Cmdlets),
			new RoleDefinition("My ReadWriteMailbox Apps", RoleType.MyReadWriteMailboxApps, CannedRoles_Dedicated.My_ReadWriteMailbox_Apps.Cmdlets),
			new RoleDefinition("MyAddressInformation", "MyContactInformation", RoleType.MyContactInformation, CannedRoles_Dedicated.MyAddressInformation.Cmdlets),
			new RoleDefinition("MyBaseOptions", RoleType.MyBaseOptions, CannedRoles_Dedicated.MyBaseOptions.Cmdlets),
			new RoleDefinition("MyContactInformation", RoleType.MyContactInformation, CannedRoles_Dedicated.MyContactInformation.Cmdlets),
			new RoleDefinition("MyDiagnostics", RoleType.MyDiagnostics, CannedRoles_Dedicated.MyDiagnostics.Cmdlets),
			new RoleDefinition("MyDisplayName", "MyProfileInformation", RoleType.MyProfileInformation, CannedRoles_Dedicated.MyDisplayName.Cmdlets),
			new RoleDefinition("MyDistributionGroupMembership", RoleType.MyDistributionGroupMembership, CannedRoles_Dedicated.MyDistributionGroupMembership.Cmdlets),
			new RoleDefinition("MyDistributionGroups", RoleType.MyDistributionGroups, CannedRoles_Dedicated.MyDistributionGroups.Cmdlets),
			new RoleDefinition("MyMailboxDelegation", RoleType.MyMailboxDelegation, CannedRoles_Dedicated.MyMailboxDelegation.Cmdlets),
			new RoleDefinition("MyMobileInformation", "MyContactInformation", RoleType.MyContactInformation, CannedRoles_Dedicated.MyMobileInformation.Cmdlets),
			new RoleDefinition("MyName", "MyProfileInformation", RoleType.MyProfileInformation, CannedRoles_Dedicated.MyName.Cmdlets),
			new RoleDefinition("MyPersonalInformation", "MyContactInformation", RoleType.MyContactInformation, CannedRoles_Dedicated.MyPersonalInformation.Cmdlets),
			new RoleDefinition("MyProfileInformation", RoleType.MyProfileInformation, CannedRoles_Dedicated.MyProfileInformation.Cmdlets),
			new RoleDefinition("MyRetentionPolicies", RoleType.MyRetentionPolicies, CannedRoles_Dedicated.MyRetentionPolicies.Cmdlets),
			new RoleDefinition("MyTeamMailboxes", RoleType.MyTeamMailboxes, CannedRoles_Dedicated.MyTeamMailboxes.Cmdlets),
			new RoleDefinition("MyTextMessaging", RoleType.MyTextMessaging, CannedRoles_Dedicated.MyTextMessaging.Cmdlets),
			new RoleDefinition("MyVoiceMail", RoleType.MyVoiceMail, CannedRoles_Dedicated.MyVoiceMail.Cmdlets),
			new RoleDefinition("Org Custom Apps", RoleType.OrgCustomApps, CannedRoles_Dedicated.Org_Custom_Apps.Cmdlets),
			new RoleDefinition("Org Marketplace Apps", RoleType.OrgMarketplaceApps, CannedRoles_Dedicated.Org_Marketplace_Apps.Cmdlets),
			new RoleDefinition("Organization Client Access", RoleType.OrganizationClientAccess, CannedRoles_Dedicated.Organization_Client_Access.Cmdlets),
			new RoleDefinition("Organization Configuration", RoleType.OrganizationConfiguration, CannedRoles_Dedicated.Organization_Configuration.Cmdlets),
			new RoleDefinition("Organization Transport Settings", RoleType.OrganizationTransportSettings, CannedRoles_Dedicated.Organization_Transport_Settings.Cmdlets),
			new RoleDefinition("POP3 And IMAP4 Protocols", RoleType.POP3AndIMAP4Protocols, CannedRoles_Dedicated.POP3_And_IMAP4_Protocols.Cmdlets),
			new RoleDefinition("PartnerDelegatedTenantManagement", RoleType.PartnerDelegatedTenantManagement, CannedRoles_Dedicated.PartnerDelegatedTenantManagement.Cmdlets),
			new RoleDefinition("Public Folders", RoleType.PublicFolders, CannedRoles_Dedicated.Public_Folders.Cmdlets),
			new RoleDefinition("Receive Connectors", RoleType.ReceiveConnectors, CannedRoles_Dedicated.Receive_Connectors.Cmdlets),
			new RoleDefinition("Recipient Policies", RoleType.RecipientPolicies, CannedRoles_Dedicated.Recipient_Policies.Cmdlets),
			new RoleDefinition("Remote and Accepted Domains", RoleType.RemoteAndAcceptedDomains, CannedRoles_Dedicated.Remote_and_Accepted_Domains.Cmdlets),
			new RoleDefinition("Reset Password", RoleType.ResetPassword, CannedRoles_Dedicated.Reset_Password.Cmdlets),
			new RoleDefinition("Retention Management", RoleType.RetentionManagement, CannedRoles_Dedicated.Retention_Management.Cmdlets),
			new RoleDefinition("Role Management", RoleType.RoleManagement, CannedRoles_Dedicated.Role_Management.Cmdlets),
			new RoleDefinition("SSARoleManagementScripts", RoleType.Custom, CannedRoles_Dedicated.SSARoleManagementScripts.Cmdlets),
			new RoleDefinition("Security Group Creation and Membership", RoleType.SecurityGroupCreationAndMembership, CannedRoles_Dedicated.Security_Group_Creation_and_Membership.Cmdlets),
			new RoleDefinition("Send Connectors", RoleType.SendConnectors, CannedRoles_Dedicated.Send_Connectors.Cmdlets),
			new RoleDefinition("Support Diagnostics", RoleType.SupportDiagnostics, CannedRoles_Dedicated.Support_Diagnostics.Cmdlets),
			new RoleDefinition("Team Mailboxes", RoleType.TeamMailboxes, CannedRoles_Dedicated.Team_Mailboxes.Cmdlets),
			new RoleDefinition("Transport Agents", RoleType.TransportAgents, CannedRoles_Dedicated.Transport_Agents.Cmdlets),
			new RoleDefinition("Transport Hygiene", RoleType.TransportHygiene, CannedRoles_Dedicated.Transport_Hygiene.Cmdlets),
			new RoleDefinition("Transport Queues", RoleType.TransportQueues, CannedRoles_Dedicated.Transport_Queues.Cmdlets),
			new RoleDefinition("Transport Rules", RoleType.TransportRules, CannedRoles_Dedicated.Transport_Rules.Cmdlets),
			new RoleDefinition("UM Mailboxes", RoleType.UMMailboxes, CannedRoles_Dedicated.UM_Mailboxes.Cmdlets),
			new RoleDefinition("UM Prompts", RoleType.UMPrompts, CannedRoles_Dedicated.UM_Prompts.Cmdlets),
			new RoleDefinition("UnScoped Role Management", RoleType.UnScopedRoleManagement, CannedRoles_Dedicated.UnScoped_Role_Management.Cmdlets),
			new RoleDefinition("Unified Messaging", RoleType.UnifiedMessaging, CannedRoles_Dedicated.Unified_Messaging.Cmdlets),
			new RoleDefinition("User Options", RoleType.UserOptions, CannedRoles_Dedicated.User_Options.Cmdlets),
			new RoleDefinition("View-Only Audit Logs", RoleType.ViewOnlyAuditLogs, CannedRoles_Dedicated.View_Only_Audit_Logs.Cmdlets),
			new RoleDefinition("View-Only Configuration", RoleType.ViewOnlyConfiguration, CannedRoles_Dedicated.View_Only_Configuration.Cmdlets),
			new RoleDefinition("View-Only Recipients", RoleType.ViewOnlyRecipients, CannedRoles_Dedicated.View_Only_Recipients.Cmdlets),
			new RoleDefinition("WorkloadManagement", RoleType.WorkloadManagement, CannedRoles_Dedicated.WorkloadManagement.Cmdlets)
		};
		...
		private class Active_Directory_Permissions
		{
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Get-User", new RoleParameters[]
				{
					...
					{
						"EXOCoreFeatures"
					}, "Anr,Arbitration,AuditLog,Credential,Debug,DomainController,ErrorAction,ErrorVariable,Filter,Identity,IgnoreDefaultScope,OrganizationalUnit,OutBuffer,OutVariable,ReadFromDomainController,RecipientTypeDetails,ResultSize,SortBy,Verbose,WarningAction,WarningVariable")
				}, "c"),
		...
		private class DataCenter_Destructive_Operations
		{
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.Setup", "New-MailboxPlan", new RoleParameters[]
				{
					...
					{
						"*"
					}, "AccountDisabled,ActiveSyncMailboxPolicy,Alias,Arbitration,ArbitrationMailbox,Archive,ArchiveDatabase,ArchiveDomain,Discovery,DisplayName,DomainController,EnableRoomMailboxAccount,Equipment,EvictLiveId,FederatedIdentity,FirstName,Force,HoldForMigration,ImmutableId,ImportLiveId,Initials,IsDefault,IsExcludedFromServingHierarchy,IsPilotMailboxPlan,LastName,LinkedCredential,LinkedDomainController,LinkedMasterAccount,MailboxPlan,MailboxPlanIndex,MailboxPlanRelease,ManagedFolderMailboxPolicy,ManagedFolderMailboxPolicyAllowed,ModeratedBy,ModerationEnabled,Name,Organization,OrganizationalUnit,OverrideRecipientQuotas,Password,PrimarySmtpAddress,PublicFolder,QueryBaseDNRestrictionEnabled,RemoteAccountPolicy,RemoteArchive,RemotePowerShellEnabled,RemovedMailbox,ResetPasswordOnNextLogon,RetentionPolicy,RoleAssignmentPolicy,Room,RoomMailboxPassword,SamAccountName,SendModerationNotifications,Shared,SharingPolicy,TargetAllMDBs,ThrottlingPolicy,UseExistingLiveId,UserPrincipalName")
				}, "c"),
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.Setup", "Remove-MailboxPlan", new RoleParameters[]
				{
					...
					{
						"*"
					}, "Arbitration,Confirm,Database,Disconnect,DomainController,Force,Identity,IgnoreDefaultScope,IgnoreLegalHold,KeepWindowsLiveID,Permanent,PublicFolder,RemoveLastArbitrationMailboxAllowed,StoreMailboxIdentity")
				}, "c"),
		...
		private class DataCenter_Operations
		{
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Get-ExchangeSettings", new RoleParameters[]
				{
					...
					{
						"*"
					}, "ConfigName,Database,Debug,Diagnostic,DiagnosticArgument,DomainController,ErrorAction,ErrorVariable,Force,GenericScopeName,GenericScopeValue,GenericScopes,Identity,OutBuffer,OutVariable,Process,Server,User,Verbose,WarningAction,WarningVariable")
				}, "c"),
			...
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Set-PushNotificationApp", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"EXOCoreFeatures"
					}, "AcsScopeUriTemplate,AcsUriTemplate,Uri,UriTemplate")
				}, "c"),
		...
		private class ExchangeCrossServiceIntegration
		{
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "New-MailUser", new RoleParameters[]
				{
					...
					}, "EvictLiveId,ImportLiveId,UseExistingLiveId")
				}, "c"),
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Remove-DistributionGroup", new RoleParameters[]
				{
					new RoleParameters(new string[]
			...
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Set-Mailbox", new RoleParameters[]
				{
					...
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"EXOCoreFeatures"
					}, "Arbitration,ArbitrationMailbox,AuditLog,ClientExtensions,Confirm,Force,GMGen,Management,MessageTracking,Migration,OABGen,OMEncryption,RetentionPolicy,SingleItemRecoveryEnabled,UMDataStorage,UMGrammar"),
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"LitigationHoldPermissions"
			...
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Get-MailboxPlan", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"EXOCoreFeatures"
					}, "Debug,DomainController,ErrorAction,ErrorVariable,Filter,Identity,IgnoreDefaultScope,OrganizationalUnit,OutBuffer,OutVariable,ResultSize,SortBy,Verbose,WarningAction,WarningVariable")
				}, "c"),
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "New-MailUser", new RoleParameters[]
				{
					...
					{
						"EXOCoreFeatures"
					}, "Alias,ArbitrationMailbox,Confirm,Debug,DisplayName,DomainController,ErrorAction,ErrorVariable,ExternalEmailAddress,FirstName,ImmutableId,Initials,LastName,MacAttachmentFormat,MailboxProvisioningConstraint,MailboxProvisioningPreferences,MessageBodyFormat,MessageFormat,Name,OrganizationalUnit,OutBuffer,OutVariable,PrimarySmtpAddress,RemotePowerShellEnabled,SamAccountName,UsePreferMessageFormat,UserPrincipalName,Verbose,WarningAction,WarningVariable,WhatIf"),
					new RoleParameters(new string[]
					{
						"ModeratedRecipientsPermissions"
					}, "ModeratedBy,ModerationEnabled,SendModerationNotifications"),
			...
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Enable-RemoteMailbox", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"EXOCoreFeatures"
					}, "ACLableSyncedObjectEnabled,Alias,Archive,ArchiveName,Confirm,Debug,DisplayName,DomainController,Equipment,ErrorAction,ErrorVariable,Identity,OutBuffer,OutVariable,PrimarySmtpAddress,RemoteRoutingAddress,Room,Verbose,WarningAction,WarningVariable,WhatIf")
				}, "c"),
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Get-CASMailboxPlan", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"EXOCoreFeatures"
					}, "Debug,DomainController,ErrorAction,ErrorVariable,Filter,Identity,IgnoreDefaultScope,OutBuffer,OutVariable,ReadFromDomainController,ResultSize,SortBy,Verbose,WarningAction,WarningVariable")
				}, "c"),
			...
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "New-MigrationBatch", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"ExchangeMigrationPermissions"
					}, "ArchiveOnly,AutoComplete,BadItemLimit,LargeItemLimit,Local,PrimaryOnly,SkipSteps,SourceEndpoint,TargetDeliveryDomain,TargetEndpoint"),
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"ExchangeMigrationPermissions",
			...
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "New-MailboxRestoreRequest", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"EXOCoreFeatures"
					}, "RemoteCredential,RemoteDatabaseGuid,RemoteHostName,RemoteRestoreType")
				}, "c"),
			...
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "New-AuthServer", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"EXOCoreFeatures"
					}, "AuthMetadataUrl,Confirm,Debug,DomainController,Enabled,ErrorAction,ErrorVariable,Name,OutBuffer,OutVariable,TrustAnySSLCertificate,Verbose,WarningAction,WarningVariable,WhatIf")
				}, "c"),
		...
		private class SSARoleManagementScripts
		{
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				new RoleCmdlet("", "Add-ManagementRoleEntry.ps1", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"*"
					}, "Identity,Overwrite,Parameters,Confirm")
				}, "s"),
				new RoleCmdlet("", "New-ManagementRole.ps1", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"*"
					}, "Name,Parent,Confirm,Description")
				}, "s"),
				new RoleCmdlet("", "Remove-ManagementRole.ps1", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"*"
				...
				new RoleCmdlet("", "Remove-ManagementRoleEntry.ps1", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"*"
				...
				new RoleCmdlet("", "Set-ManagementRoleEntry.ps1", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"*"
					}, "Identity,Parameters,AddParameter,RemoveParameter,Confirm")
				}, "s")
			};
		}
			...
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Get-QueueDigest", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						"EOPPremiumRestrictions",
						"EXOCoreFeatures"
					}, "Dag,Debug,DetailsLevel,ErrorAction,ErrorVariable,Filter,Forest,GroupBy,IncludeE14Servers,OutBuffer,OutVariable,ResultSize,Server,Site,Timeout,Verbose,WarningAction,WarningVariable")
				}, "c"),
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Get-SearchDocumentFormat", new RoleParameters[]
				{
					new RoleParameters(new string[]
			...
			internal static RoleCmdlet[] Cmdlets = new RoleCmdlet[]
			{
				...
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Set-MalwareFilterRule", new RoleParameters[]
				{
					new RoleParameters(new string[]
					{
						...
						"MalwareFilteringPolicyCustomizationEnabled",
						"PilotingOrganization_Restrictions"
					}, "Comments,Confirm,Debug,ErrorAction,ErrorVariable,ExceptIfRecipientDomainIs,ExceptIfSentTo,ExceptIfSentToMemberOf,Identity,MalwareFilterPolicy,Name,OutBuffer,OutVariable,Priority,RecipientDomainIs,SentTo,SentToMemberOf,Verbose,WarningAction,WarningVariable,WhatIf")
				}, "c"),
				new RoleCmdlet("Microsoft.Exchange.Management.PowerShell.E2010", "Set-MalwareFilteringServer", new RoleParameters[]
				{
					new RoleParameters(new string[]
